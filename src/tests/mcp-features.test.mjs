...
describe("MCP resources & prompts", () => {
  ...
  it("registers all curated prompts", () => {
    ...
    for (const name of ["whats-on-today", "compare-odds", "motorsport-weekend", "league-standings", "team-deep-dive", "f1-race", "build-football-trade", "backtest-football-strategy"]) {
